...
namespace ImageLib
{
    public static class FxImageASCIIArt
    {
        public static string ASCIIFilter(Bitmap sourceBitmap, int pixelBlockSize,
                                                                   int colorCount = 0)
        {
        ...
        private static string GenerateRandomString(int maxSize)
        {
            ...
            return RandomStringSort(stringBuilder.ToString());
        }

        public static string RandomStringSort(string stringValue)
        {
