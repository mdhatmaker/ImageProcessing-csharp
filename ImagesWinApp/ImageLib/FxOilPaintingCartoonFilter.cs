...
namespace ImageLib
{
    public static class FxOilPaintingCartoonFilter
    {
        public class Parameters
        {
            public decimal[] IntensityLevels = new decimal[] { 25, 5, 150 };
            public object[] FilterSize = new object[] { "3", "5", "7", "9", "11", "13", "15" };
            public int[] Threshold = new int[] { 50, 0, 200 };
        }
        ...
        public static Bitmap CartoonFilter(Bitmap sourceBitmap,
                                               int levels,
                                               int filterSize,
                                               byte threshold)
        {
            Bitmap paintFilterImage =
                   OilPaintFilter(sourceBitmap, levels, filterSize);

            Bitmap edgeDetectImage =
                GradientBasedEdgeDetectionFilter(sourceBitmap, threshold);
        ...
        public static Bitmap OilPaintFilter(Bitmap sourceBitmap,
                                               int levels,
                                               int filterSize)
        {
    ...
    } // end of class FxOilPaintingCartoonFilter
} // end of namespace
